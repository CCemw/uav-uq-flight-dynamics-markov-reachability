...
% Produces:
%   figs/Fig05_Cl_Cd_polars.pdf    The lift and drag coefficients of all
%                                  three measured blade-section airfoils
%                                  against angle of attack at M = 0.30,
%                                  shown side by side.
%   figs/Fig05b_Cl_Cd_sigma.pdf    The same polars reduced to a mean curve
%                                  with a pointwise standard deviation
%                                  band derived from the range of the
%                                  three airfoils divided by the d2
%                                  constant.
%
% Reads:  ../00_inputs/polars/afl{13,14,15}.c81.txt
...
% C81 polar (change if different col & row)
for k = 1:3
